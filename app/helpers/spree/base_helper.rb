  ...
  module BaseHelper
    ...
    def meta_data_tags
      ...
      if object.kind_of?(ActiveRecord::Base)
        ...
        meta = { :keywords => "football shirts, soccer jerseys, football kits, cheap, whole sale",
                 :description => "theFootballShirt.com - The largest online collection for cheap football shirts, soccer jerseys, football kits in reasonable prices. Wholesale is available." }
      end
